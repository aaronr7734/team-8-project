...
from ..models import Category, Discount  # Assuming Discount is another model in your application

class CategoryModelTest(TestCase):
    """
    Tests for the Category model, ensuring that each aspect of the model functions as expected.
